...
namespace ChatBot
{
    ...
    public partial class ChatBot : Form 
    {
        ...
        public ChatBot()
        {
            ...
            using (Login loginForm = new Login()) //Пример ассоциации, потому что главная форма временно использует
            //форму логина для получения имени пользователя (userName), но не содержит его как постоянную часть.
            //После закрытия формы логина связь между объектами разрывается и они существуют независимо
            {
